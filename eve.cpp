...
void eve::Calculate(int player,int enemy) {
    int MyNum = 0;
    int EnemyNum = 0;
    int emptyNum=0;
    //清空落点价值
...
void eve::paintEvent(QPaintEvent *event){
...
void eve::mouseReleaseEvent(QMouseEvent *event){
    Calculate((now==black)?black:white,(now==black)?white:black);
    AIset((now==black)?black:white);
